...
<xsl:template name="footer.content">
  ...
  <!-- HANDBOOK -->
    <!-- Test to obtain information -->
    <!--
    <xsl:choose>
    	<xsl:when test="$sequence = 'odd'">odd-</xsl:when>
    	<xsl:when test="$sequence = 'even'">even-</xsl:when>
    	<xsl:when test="$sequence = 'first'">first-</xsl:when>
    	<xsl:when test="$sequence = 'blank'">blank-</xsl:when>
    ...
    <xsl:choose>
    	<xsl:when test="$pageclass = 'front'">front</xsl:when>
    	<xsl:when test="$pageclass = 'body'">body</xsl:when>
    	<xsl:when test="$pageclass = 'lot'">lot</xsl:when>
    	<xsl:when test="$pageclass = 'titlepage'">titlepage</xsl:when>
    	<xsl:otherwise>otherwise</xsl:otherwise>
    </xsl:choose>
    -->
