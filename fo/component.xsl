...
<xsl:template name="component.title">
  ...
  <xsl:attribute name="color">blue</xsl:attribute> <!-- ALTRAN : HANDBOOK : Titles in blue -->
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        ...
        <fo:block text-align="left" font-weight="bold">  <!-- handbook : add this line to center article title -->
        <!-- Fail, doesn't do a thing, align is set to left -->
          <xsl:copy-of select="$title"/>
        </fo:block>
      </xsl:otherwise>
    </xsl:choose>
