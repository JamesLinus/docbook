...
<xsl:param name="body.start.indent">
  <xsl:choose>
    ...
    <!-- handbook<xsl:otherwise>4pc</xsl:otherwise>-->
...
<xsl:attribute-set name="component.title.properties">
  <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute> <!-- default : always -->
  <xsl:attribute name="space-before.optimum"><xsl:value-of select="concat($body.font.master, 'pt')"/></xsl:attribute>
  <xsl:attribute name="space-before.minimum"><xsl:value-of select="concat($body.font.master, 'pt * 0.8')"/></xsl:attribute>
  <xsl:attribute name="space-before.maximum"><xsl:value-of select="concat($body.font.master, 'pt * 1.2')"/></xsl:attribute>
  <xsl:attribute name="hyphenate">false</xsl:attribute>
...
<xsl:attribute-set name="footnote.properties">
  ...
  <xsl:attribute name="linefeed-treatment">preserve</xsl:attribute> <!-- default value : treat-as-space -->
</xsl:attribute-set>
...
<xsl:param name="highlight.xslthl.config">file:///C:/FPGA/xslthl-config.xml</xsl:param>
<xsl:param name="xslthl.config">file:///C:/FPGA/xslthl-config.xml</xsl:param>
...
<xsl:attribute-set name="monospace.verbatim.properties" use-attribute-sets="verbatim.properties monospace.properties">
  <xsl:attribute name="text-align">start</xsl:attribute> <!-- handbook: ddefault value is "start"-->
